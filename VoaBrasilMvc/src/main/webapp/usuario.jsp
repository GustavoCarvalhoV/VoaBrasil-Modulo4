        ...
        <main>
            <div class="container mt-5">
				...
				<table class="table">
				  ...
				  <tbody>
				    <jstl:forEach items="${usuarios}" var="u">
                    <tr>
                    	<td>${u.id}</td>
                        <td>${u.nome}</td>
                        <td>${u.sobrenome}</td>
                        ...
                        <td>
                            <a href="usuario-edit?id=${u.id}" class="btn btn-primary mb-1" >Editar</a>

                            <a href="usuario-delete?id=${u.id}" onclick="return confirm('Deseja excluir ${u.nome}?')" class="btn btn-danger mb-1">Excluir</a>
                        </td>
