    ...
    <body>
        ...
        <main>
            <div class="container mt-5">
                <h1 class="mb-4">Lista de Destinos</h1>
				...
				<table class="table">
				  ...
				  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="destino-edit?id=${d.id}" class="btn btn-primary mb-1" >Editar</a>

                            <a href="destino-delete?id=${d.id}" onclick="return confirm('Deseja excluir ${d.cidade}?')" class="btn btn-danger mb-1">Excluir</a>
                        </td>
